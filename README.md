# O Empire: Ward the Flowering Rot
...
## Play
Open `index.html`, or play the GitHub Pages build.

## Controls
- WASD / arrows: walk
- Shift: run
- R: kneel and recover stamina
- E: search nearby caches
- 1 / 2: bread / tincture
- Gamepad and touch controls are supported

No external assets, frameworks, telemetry, or copied project code.
